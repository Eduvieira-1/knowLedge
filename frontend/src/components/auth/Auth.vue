<template>
  <div class="auth-content">
    <div class="auth-modal">
        ...
        <button class="btn btn-outline-primary" v-if="showSignup" @click="signup">Registrar</button>
        <button class="btn btn-outline-primary" v-else @click="signin">Entrar</button>
